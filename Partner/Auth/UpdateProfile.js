...
router.post("/", async (req, res) => {
  ...
  const fieldMap = {
    ...
    address_visibility: agentProfile.address_visibility || agentProfile.addressVisibility,
    country: agentProfile.country,
    service_id: agentProfile.service_id || agentProfile.serviceId,
    service_type: agentProfile.service_type || agentProfile.serviceType,
    ...
    address_line2: agentProfile.address_line2 || agentProfile.addressLine2 || agentProfile.area,
    address_line3: agentProfile.address_line3 || agentProfile.addressLine3 || agentProfile.address_line_3,
